...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "google-cloud-spanner-admin-database-v1", "~> 1.0"
  gem.add_dependency "google-cloud-spanner-admin-instance-v1", "~> 1.0"
  gem.add_dependency "google-cloud-spanner-v1", "~> 1.0"
end
