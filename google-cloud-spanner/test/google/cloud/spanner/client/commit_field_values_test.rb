...
describe Google::Cloud::Spanner::Client, :read, :mock_spanner do
  ...
  describe "commit_timestamp" do
    it "commits using a block" do
      ...
      mock.expect :commit, commit_resp, [{ session: session_grpc.name, mutations: mutations, transaction_id: nil, single_use_transaction: tx_opts, request_options: nil }, default_options_commit]
