...
describe Google::Cloud::Spanner::Interval, :parse_interval do
  ...
  it "parses for negative minutes" do
    ...
    _(interval.days).must_equal 3
    _(interval.nanoseconds).must_equal 43_926_000_000_000
  end
  ...
  it "parses with year only" do
    ...
    _(interval).must_be_kind_of Google::Cloud::Spanner::Interval
    _(interval.months).must_equal 12
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 0
  end
  ...
  it "parses with month only" do
    ...
    _(interval).must_be_kind_of Google::Cloud::Spanner::Interval
    _(interval.months).must_equal 2
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 0
  end
  ...
  it "parses with time only" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 15_906_789_000_100
  end
  ...
  it "parses with time only, no decimal point" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 15_906_000_000_000
  end
  ...
  it "parses with no minute in time part" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 14_430_000_000_000
  ...
  it "parses with no second in time part" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 14_460_000_000_000
  end
  ...
  it "parses with only minute in time part" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 300_000_000_000
  end
  ...
  it "parses with only second in time part" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 6_789_000_000
  end
  ...
  it "parses with only fractional second" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 123_000_000 
  ...
  it "parses with no 0 before decimal point" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 123
  end
  ...
  it "parses with negative signs in each part" do
    ...
    _(interval.months).must_equal -14
    _(interval.days).must_equal -3
    _(interval.nanoseconds).must_equal -43_926_789_000_123
  end

  it "parses with mixed signs" do
    interval = Interval.parse "P1Y-2M3DT13H-51M6.789S"
    _(interval).must_be_kind_of Google::Cloud::Spanner::Interval
    _(interval.months).must_equal 10
    _(interval.days).must_equal 3
    _(interval.nanoseconds).must_equal 43_746_789_000_000 
  ...
  it "parses with mixed signs (2)" do
    ...
    _(interval.months).must_equal -10
    _(interval.days).must_equal -3
    _(interval.nanoseconds).must_equal -43_866_789_000_000
  ...
  it "parses with mixed signs (3)" do
    ...
    _(interval.months).must_equal 14
    _(interval.days).must_equal 3
    _(interval.nanoseconds).must_equal -12_906_789_000_100
  end
  ...
  it "parses with mixed signs (4)" do
    ...
    _(interval.months).must_equal -10
    _(interval.days).must_equal 3
    _(interval.nanoseconds).must_equal 41_401_234_000_000
  end
  ...
  it "parses without normal bounds" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 366_100_500_000_000
  end
  ...
  it "parses with date and time, no seconds" do
    ...
    _(interval.months).must_equal 14
    _(interval.days).must_equal 3
    _(interval.nanoseconds).must_equal 45_000_000_000_000
  end
  ...
  it "parses fractional seconds with max digits" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 123_456_789
  ...
  it "parses hours and fractional seconds" do 
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 3_600_500_000_000
  end
  ...
  it "parses with full interval representation" do
    ...
    _(interval.months).must_equal 14
    _(interval.days).must_equal 3
    _(interval.nanoseconds).must_equal 45_001_234_567_890 
  end
  ...
  it "parses with trailing zeros after decimal" do 
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 1_234_000_000
  ...
  it "parses with all zeros after decimal" do
    ...
    _(interval.months).must_equal 0
    _(interval.days).must_equal 0
    _(interval.nanoseconds).must_equal 1_000_000_000
  end
end
